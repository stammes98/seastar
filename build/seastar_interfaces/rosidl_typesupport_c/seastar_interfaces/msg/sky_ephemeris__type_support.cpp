...
static const _SkyEphemeris_type_support_symbol_names_t _SkyEphemeris_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seastar_interfaces, msg, SkyEphemeris)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, seastar_interfaces, msg, SkyEphemeris)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, seastar_interfaces, msg, SkyEphemeris)() {
  return &::seastar_interfaces::msg::rosidl_typesupport_c::SkyEphemeris_message_type_support_handle;
}
