...
#include "seastar_interfaces/msg/detail/desired_pointing__rosidl_typesupport_fastrtps_c.h"
...
using _DesiredPointing__ros_msg_type = seastar_interfaces__msg__DesiredPointing;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DesiredPointing__ros_msg_type * ros_message = static_cast<const _DesiredPointing__ros_msg_type *>(untyped_ros_message);
  // Field name: azimuth
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DesiredPointing__ros_msg_type * ros_message = static_cast<_DesiredPointing__ros_msg_type *>(untyped_ros_message);
  // Field name: azimuth
  {
    cdr >> ros_message->azimuth;
  }
...
static uint32_t _DesiredPointing__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_seastar_interfaces__msg__DesiredPointing(
...
static size_t _DesiredPointing__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_seastar_interfaces__msg__DesiredPointing(
...
static message_type_support_callbacks_t __callbacks_DesiredPointing = {
...
static rosidl_message_type_support_t _DesiredPointing__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DesiredPointing,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seastar_interfaces, msg, DesiredPointing)() {
  return &_DesiredPointing__type_support;
}
