...
static const _SkyScanPointingAngles_type_support_symbol_names_t _SkyScanPointingAngles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, seastar_interfaces, msg, SkyScanPointingAngles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, seastar_interfaces, msg, SkyScanPointingAngles)),
  }
};
...
{
  return &::seastar_interfaces::msg::rosidl_typesupport_cpp::SkyScanPointingAngles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, seastar_interfaces, msg, SkyScanPointingAngles)() {
  return get_message_type_support_handle<seastar_interfaces::msg::SkyScanPointingAngles>();
}
