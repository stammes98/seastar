...
class Metaclass_SkyEphemeris(type):
    """Metaclass of message 'SkyEphemeris'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'seastar_interfaces.msg.SkyEphemeris')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sky_ephemeris
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sky_ephemeris
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sky_ephemeris
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sky_ephemeris
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sky_ephemeris
...
class SkyEphemeris(metaclass=Metaclass_SkyEphemeris):
    """Message class 'SkyEphemeris'."""
