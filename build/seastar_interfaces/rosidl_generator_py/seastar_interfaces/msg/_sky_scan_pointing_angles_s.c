...
bool seastar_interfaces__msg__sky_scan_pointing_angles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("seastar_interfaces.msg._sky_scan_pointing_angles.SkyScanPointingAngles", full_classname_dest, 70) == 0);
  }
  seastar_interfaces__msg__SkyScanPointingAngles * ros_message = _ros_message;
  {  // azimuth
...
{
  /* NOTE(esteve): Call constructor of SkyScanPointingAngles */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("seastar_interfaces.msg._sky_scan_pointing_angles");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkyScanPointingAngles");
