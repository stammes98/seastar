...
bool seastar_interfaces__msg__motor_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("seastar_interfaces.msg._motor_command.MotorCommand", full_classname_dest, 50) == 0);
  }
  seastar_interfaces__msg__MotorCommand * ros_message = _ros_message;
  {  // q1
...
PyObject * seastar_interfaces__msg__motor_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("seastar_interfaces.msg._motor_command");
